...
const IntervantsListe = () => {
  ...
  const intervenants = useSelector(
    (state) => state.IntervenantReducer.intervenants,
  )
          ...
          {intervenants
            .filter((intervenant) => {
              if (searchTerm == '') {
                ...
                intervenant.Prenom.toLowerCase().includes(
                  searchTerm.toLowerCase(),
                ) ||
                intervenant.Nom.toLowerCase().includes(searchTerm.toLowerCase())
              ) {
